...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener {
    //Activity que funciona como selector de imágenes.
    //Muestra una serie de imágenes y devuelve el número
    //correspondiente a la imagen seleccionada por el usuario
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        miBitMap= BitmapFactory.decodeResource(getResources(), R.drawable.av3);
        iv2.setImageBitmap(miBitMap);
        //iv2.setImageDrawable(getResources().getDrawable(R.drawable.av3));
        miBitMap= BitmapFactory.decodeResource(getResources(), R.drawable.av4);
